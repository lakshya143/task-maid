...
export async function GET() {
  try {
    ...
    const [deletedTasks, deletedInstances] = await Promise.all([
    ...
    return NextResponse.json({
      success: true,
      deleted: { masterTasks: deletedTasks, taskInstances: deletedInstances },
      seeded: count,
      message: `✅ Reset and seeded: deleted ${deletedTasks} old tasks + ${deletedInstances} instances, created ${count} fresh tasks.`,
    });
  } catch (err) {
